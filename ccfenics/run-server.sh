...
#   docker build -t dolfinx-mcp https://github.com/ekstanley/ccFenics-plugin.git
...
if ! docker image inspect dolfinx-mcp &>/dev/null 2>&1; then
  ...
  echo "  docker build -t dolfinx-mcp https://github.com/ekstanley/ccFenics-plugin.git" >&2
  exit 1
fi
